...
public class StrippableStairBlock extends StairBlockWithBase {
    private final StairBlockWithBase strippedBlock;
    
    public StrippableStairBlock(Block base, StairBlockWithBase strippedBlock) {
        super(base, BingusExtrasMod.ToolType.AXE);
        this.strippedBlock = strippedBlock;
    }

    public StrippableStairBlock(Block base, StairBlockWithBase strippedBlock, String sideTexture, String bottomTexture, String topTexture) {
        super(base, sideTexture, bottomTexture, topTexture, BingusExtrasMod.ToolType.AXE);
        this.strippedBlock = strippedBlock;
    }

    public StrippableStairBlock(Block base, StairBlockWithBase strippedBlock, String texture) {
        super(base, texture, BingusExtrasMod.ToolType.AXE);
        this.strippedBlock = strippedBlock;
    }

    public StrippableStairBlock(Block base, StairBlockWithBase strippedBlock, String sideTexture, String topBottomTexture) {
