...
public class TwilightChakramEntityRenderer<T extends Entity> extends EntityRenderer<T> {
    private static final float MIN_DISTANCE = 12.25f;
    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean lit;

    public TwilightChakramEntityRenderer(EntityRendererFactory.Context ctx, float scale, boolean lit) {
        super(ctx);
    ...
    public TwilightChakramEntityRenderer(EntityRendererFactory.Context context) {
    ...
    public void render(T entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        ...
        matrices.multiply(RotationAxis.POSITIVE_Z.rotation((entity.age + tickDelta)));
